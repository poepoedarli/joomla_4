...
<ul class="list-unstyled yt-loginform nav">
	<li class="log login"> <a class="link-lg" data-toggle="modal" href="#myLogin"><?php echo JText::_('MOD_LOGIN'); ?> </a></li>
<?php if ($usersConfig->get('allowUserRegistration')) : ?>
	<li>
		<a href="<?php echo Route::_($registerLink); ?>"><?php echo JText::_('Register'); ?></a>
	</li>
<?php endif; ?>
</ul>
