...
?>
	...
	<?php }?>
	<div id="<?php echo $uniquied?>" class="sj-basic-news carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner bs-items">
			<?php $i = 0;  foreach($list as $item){ $i++;
				...
				//var_dump($item);
			?>
			<div class="carousel-item bs-item cf <?php if($i==1){echo "active";}?> <?php echo $show_line.' '.$last_class; ?>">
				<?php if($img){?>
				<div class="bs-image">
